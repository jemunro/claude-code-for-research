...
\begin{center}
\href{https://paulgp.substack.com/p/getting-started-with-claude-code}{\includegraphics[width=0.88\textwidth, height=0.74\textheight, keepaspectratio]{figures/llm-anatomy.png}}
\end{center}
...
::: {.column width="48%"}
\begin{center}
\includegraphics[width=\textwidth, height=0.68\textheight, keepaspectratio]{figures/paper-note.jpg}
...
::: {.column width="48%"}
\begin{center}
\includegraphics[width=\textwidth, height=0.68\textheight, keepaspectratio]{figures/paper-summarised.png}
...
\begin{center}
\href{https://paulgp.substack.com/p/getting-started-with-claude-code}{\includegraphics[width=0.88\textwidth, height=0.74\textheight, keepaspectratio]{figures/context-engineering.png}}
\end{center}
...
\begin{center}
\includegraphics[width=0.88\textwidth, height=0.74\textheight, keepaspectratio]{figures/email-invite.png}
\end{center}
